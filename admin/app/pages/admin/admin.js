System.register(['angular2/core', 'angular2/common', '../../services/data/data', '../../services/validation/validation', '../../directives/material/material', '../../directives/common/common', '../../pipes/custom.pipes'], function(exports_1, context_1) {
    ...
    return {
        ...
        execute: function() {
            AdminPage = (function () {
                function AdminPage(dataService, fb) {
                    this.dataService = dataService;
                    this.fb = fb;
                    this._moduleRef = 'admin';
                    this.mode = 'list';
                    this.form = fb.group({
                        _ref: [""],
                    ...
                    this.list = {
                        ...
                        fields: [
                            ...
                            { code: 'lastname', title: 'Last Name', type: 'text', 'formatter': '' },
                ...
                AdminPage.prototype.addNew = function () {
                    this.selectedItem = {};
                    this.mode = 'edit';
                };
                AdminPage.prototype.editItem = function (id) {
                ...
                AdminPage.prototype.cancelEdit = function () {
                    this.selectedItem = null;
                    this.mode = 'list';
                };
                AdminPage.prototype.saveItem = function () {
                    if (this.form.valid) {
                ...
                AdminPage.prototype.deleteItem = function (id) {
                    var result = confirm("Do you want to delete this item?");
                    if (result) {
                        this.dataService.deleteAdmin(id);
                    }
                };
                AdminPage.prototype.saveImage = function (event, model, identifier) {
                    var _this = this;
